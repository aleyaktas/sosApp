...
//   const {questions, setQuestions} = useContext(MultipleChoiceContext);
...
//       console.log('SwiperRef', swiperRef.current?.getCurrentIndex());
//       setCurrentQuestion(swiperRef.current?.getCurrentIndex());
//     }
//     // if(swiperRef.current?.goToLastIndex()) {
...
//     const isCorrect = question.dogru_secenek === optionTitle;
...
const MultipleChoice = () => {
  ...
  const {questions, setQuestions, fetchQuestions, loading} = useContext(
  ...
  const checkAnswer = (selectedOption: string, optionTitle: string) => {
    ...
    // console.log('question d s', question?.dogru_secenek);
