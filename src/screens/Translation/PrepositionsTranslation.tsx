...
import {
  IfClausesTranslationSentences,
  PrepositionsTranslationSentences,
...
const PrepositionsTranslation = () => {
  ...
  const generateQuestion = () => {
    ...
    let newTranslationSentences =
      PrepositionsTranslationSentences[newSelectedSymbol];
  ...
  const checkAnswer = () => {
    ...
    if (textInputValue.join(' ') === answer) {
      ...
      const translationSentences =
        PrepositionsTranslationSentences[selectedCell as SymbolKeys];
      ...
      <ScrollView style={styles.scrollView}>
        <View
          ...
          <CellSelectionComponent
            ...
            cells={[
              {
                value: 'AdjectivePreposition',
                label: 'Adjective + Preposition',
              },
              {
                value: 'Place',
              ...
              {
                value: 'VerbPreposition',
                label: 'Verb + Preposition',
              },
            ]}
          />
          <QuestionComponent
...
export default PrepositionsTranslation;
