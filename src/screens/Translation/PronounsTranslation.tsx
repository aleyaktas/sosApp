...
import {PronounsTranslationSentences} from '../../utils/translation';

const PronounsTranslation = () => {
  ...
  type SymbolKeys = 'IMe' | 'IMine' | 'IMy' | 'IMyself';
  ...
  const generateQuestion = () => {
    ...
    let newTranslationSentences =
      PronounsTranslationSentences[newSelectedSymbol];
  ...
  const checkAnswer = () => {
    ...
    if (textInputValue.join(' ') === answer) {
      ...
      const translationSentences =
        PronounsTranslationSentences[selectedCell as SymbolKeys];
...
export default PronounsTranslation;
