        ...
        <View
          ...
          <CellSelectionComponent
            ...
            cells={[
              {
                value: 'SPronouns',
                label: 'Somebody, SomeOne, Something, Somewhere',
              },
              {
                value: 'EPronouns',
                label: 'Everybody, Everyone, Everything, Everywhere',
              },
              {
                value: 'APronouns',
                label: 'Anybody, Anyone, Anything, Anywhere',
              },
              {value: 'NPronouns', label: 'Nobody, No One, Nothing, Nowhere'},
            ]}
          />
          <QuestionComponent
            sentence={sentence}
