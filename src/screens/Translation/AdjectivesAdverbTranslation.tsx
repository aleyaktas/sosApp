...
import {AdjectivesAdverbsTranslationSentences} from '../../utils/translation';

const AdjectivesAdverbTranslation = () => {
  ...
  type SymbolKeys = 'Adjectives' | 'Adverbs' | 'AdjectivesAdverbs';
  ...
  const generateQuestion = () => {
    ...
    let newTranslationSentences =
      AdjectivesAdverbsTranslationSentences[newSelectedSymbol];
  ...
  const checkAnswer = () => {
    ...
    if (textInputValue.join(' ') === answer) {
      ...
      const translationSentences =
        AdjectivesAdverbsTranslationSentences[selectedCell as SymbolKeys];
      ...
      <ScrollView style={styles.scrollView}>
        <View
          ...
          <CellSelectionComponent
            ...
            cells={[
              {value: 'Adjectives', label: 'Sıfatlar'},
              {value: 'Adverbs', label: 'Zarflar'},
              {value: 'AdjectivesAdverbs', label: 'Sıfatlar ve Zarflar'},
            ]}
          />
          <QuestionComponent
            sentence={sentence}
...
export default AdjectivesAdverbTranslation;
