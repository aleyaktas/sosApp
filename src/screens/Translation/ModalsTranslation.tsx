...
import {ModalsTranslationSentences} from '../../utils/translation';
...
const ModalsTranslation = () => {
  ...
  const generateQuestion = () => {
    ...
    let newTranslationSentences = ModalsTranslationSentences[newSelectedSymbol];
  ...
  const checkAnswer = () => {
    ...
    if (textInputValue.join(' ') === answer) {
      ...
      const translationSentences =
        ModalsTranslationSentences[selectedCell as SymbolKeys];
...
export default ModalsTranslation;
