...
import {ComparativesSuperlativesTranslationSentences} from '../../utils/translation';

const ComparativesSuperlativesTranslation = () => {
  ...
  type SymbolKeys = 'Comparatives' | 'Superlatives';
  ...
  const generateQuestion = () => {
    ...
    let newTranslationSentences =
      ComparativesSuperlativesTranslationSentences[newSelectedSymbol];
  ...
  const checkAnswer = () => {
    ...
    if (textInputValue.join(' ') === answer) {
      ...
      const translationSentences =
        ComparativesSuperlativesTranslationSentences[
          selectedCell as SymbolKeys
        ];
...
export default ComparativesSuperlativesTranslation;
