...
import {ThereIsAreTranslationSentences} from '../../utils/translation';

const ThereIsAreTranslation = () => {
  ...
  type SymbolKeys = 'IsAre' | 'WasWere' | 'WillBe';
  ...
  const generateQuestion = () => {
    ...
    let newTranslationSentences =
      ThereIsAreTranslationSentences[newSelectedSymbol];
  ...
  const checkAnswer = () => {
    ...
    if (textInputValue.join(' ') === answer) {
      ...
      const translationSentences =
        ThereIsAreTranslationSentences[selectedCell as SymbolKeys];
...
export default ThereIsAreTranslation;
