...
import {PossessiveSOFTranslationSentences} from '../../utils/translation';

const PossessiveSOfTranslation = () => {
  ...
  type SymbolKeys = 'PossessiveS' | 'PossessiveOf';
  ...
  const generateQuestion = () => {
    ...
    let newTranslationSentences =
      PossessiveSOFTranslationSentences[newSelectedSymbol];
  ...
  const checkAnswer = () => {
    ...
    if (textInputValue.join(' ') === answer) {
      ...
      const translationSentences =
        PossessiveSOFTranslationSentences[selectedCell as SymbolKeys];
...
export default PossessiveSOfTranslation;
