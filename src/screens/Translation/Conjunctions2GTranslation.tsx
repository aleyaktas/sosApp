...
import {
  Conjuction1GTranslationSentences,
  Conjuction2GTranslationSentences,
} from '../../utils/translation';

const Conjunctions2GTranslation = () => {
  ...
  type SymbolKeys = 'Neden' | 'Zıtlık' | 'AynıFikriSürdürme' | 'Diğer';
  ...
  const generateQuestion = () => {
    ...
    let newTranslationSentences =
      Conjuction2GTranslationSentences[newSelectedSymbol];
  ...
  const checkAnswer = () => {
    ...
    if (textInputValue.join(' ') === answer) {
      ...
      const translationSentences =
        Conjuction2GTranslationSentences[selectedCell as SymbolKeys];
...
export default Conjunctions2GTranslation;
